// "chain_sendrecv.c" - An MPI chain example, in which each process sends a 
// message to the right and receives a message from its left in a
// combined call
//
//     (0) -> (1) -> ... ... -> (p)
//
...
int main(int argc, char *argv[])
{
    ...
    MPI_Sendrecv(smsg,n,MPI_DOUBLE,right,tag,
        rmsg,n,MPI_DOUBLE,left,tag,MPI_COMM_WORLD,&rstat);
